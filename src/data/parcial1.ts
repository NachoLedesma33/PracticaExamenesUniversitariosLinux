...
export const PARCIAL_1_CHALLENGES: Challenge[] = [
  ...
  { id: 'p1-09', category: 'PARCIAL 1 - Enlaces', instruction: 'Crear un enlace físico del archivo "num10" en su mismo directorio con el nombre "enlanum".', hint: 'ln ../num10 ../enlanum', solutionHint: 'ln ../num10 ../enlanum', initialState: goGrupo, validationType: 'state', validateState: fileExists('../enlanum'), commands: ['ln'], difficulty: 'medio' },

  { id: 'p1-10', category: 'PARCIAL 1 - FileSystem', instruction: 'Visualizar el contenido de "lista" de modo que muestre los nombres y los números de nodo-i (i-nodos) de los archivos.', hint: 'ls -i ../lista', solutionHint: 'ls -i ../lista', initialState: goGrupo, validationType: 'command', expectedCommandRegex: /ls\s+-i/, commands: ['ls'], difficulty: 'fácil' },

  { id: 'p1-11', category: 'PARCIAL 1 - FileSystem', instruction: 'Crear una copia de "letras" dentro del directorio "dire" con el nombre "copilet".', hint: 'cp ../../letras ../copilet', solutionHint: 'cp ../../letras ../copilet', initialState: goGrupo, validationType: 'state', validateState: fileExists('../copilet'), commands: ['cp'], difficulty: 'fácil' },

  { id: 'p1-12', category: 'PARCIAL 1 - FileSystem', instruction: 'Crear una copia del archivo "letras" en el directorio actual ("grupo") manteniendo el mismo nombre.', hint: 'cp ../../letras .', solutionHint: 'cp ../../letras .', initialState: goGrupo, validationType: 'state', validateState: fileExists('letras'), commands: ['cp'], difficulty: 'fácil' },

  { id: 'p1-13', category: 'PARCIAL 1 - Navegación', instruction: 'Cambiarse de regreso al directorio padre "dire".', hint: 'cd ..', solutionHint: 'cd ..', initialState: goGrupo, validationType: 'state', validateState: cwdIs(DIRE), commands: ['cd'], difficulty: 'fácil' },

  { id: 'p1-14', category: 'PARCIAL 1 - Filtros', instruction: 'Visualizar las últimas dos líneas del archivo "numeros".', hint: 'tail -2 ../numeros', solutionHint: 'tail -2 ../numeros', initialState: goDire, validationType: 'command', expectedCommandRegex: /tail\s+-2/, commands: ['tail'], difficulty: 'fácil' },

  { id: 'p1-15', category: 'PARCIAL 1 - FileSystem', instruction: 'Renombrar el archivo "numeros" con el nombre "nuevonum".', hint: 'mv ../numeros ../nuevonum', solutionHint: 'mv ../numeros ../nuevonum', initialState: goDire, validationType: 'state', validateState: allOf(fileExists('../nuevonum'), (s) => s.getNode(resolvePath(s.cwd, '../numeros')) ? 'El archivo original numeros no debería existir.' : null), commands: ['mv'], difficulty: 'fácil' },

  // ============ BLOQUE 2: Entubamientos, Filtros y Manipulación Avanzada (16-39) ============

  { id: 'p1-16', category: 'PARCIAL 1 - Filtros', instruction: 'Visualizar el listado de los dispositivos del sistema ("/dev") a partir del cuarto dispositivo y de a 5 por vez.', hint: 'ls /dev | more +4 5', solutionHint: 'ls /dev | more +4 5', initialState: goHome, validationType: 'command', expectedCommandRegex: /ls.*\|.*more/, commands: ['ls', 'more'], difficulty: 'medio' },

  { id: 'p1-17', category: 'PARCIAL 1 - Filtros', instruction: 'Visualizar los comandos de "/bin" cuyos nombres comienzan exactamente con la letra "m".', hint: 'ls /bin | grep "^m"', solutionHint: 'ls /bin | grep "^m"', initialState: goHome, validationType: 'command', expectedCommandRegex: /ls.*\|.*grep.*\^m/, commands: ['ls', 'grep'], difficulty: 'medio' },

  { id: 'p1-18', category: 'PARCIAL 1 - Filtros', instruction: 'Visualizar únicamente los últimos dos comandos de "/bin" cuyos nombres comienzan con "m".', hint: 'ls /bin | grep "^m" | tail -2', solutionHint: 'ls /bin | grep "^m" | tail -2', initialState: goHome, validationType: 'command', expectedCommandRegex: /ls.*\|.*grep.*\|.*tail/, commands: ['ls', 'grep', 'tail'], difficulty: 'medio' },

  { id: 'p1-19', category: 'PARCIAL 1 - FileSystem', instruction: 'Trasladar "let10" y "num10" en un solo paso al "home directory" con sus mismos nombres.', hint: 'mv let10 num10 ../..', solutionHint: 'mv let10 num10 ../..', initialState: goDire, validationType: 'state', validateState: allOf(fileExists('../../let10'), fileExists('../../num10'), (s) => { if (s.getNode(resolvePath(s.cwd, 'let10'))) return '"let10" aún existe en el origen.'; if (s.getNode(resolvePath(s.cwd, 'num10'))) return '"num10" aún existe en el origen.'; return null; }), commands: ['mv'], difficulty: 'medio' },

  { id: 'p1-21', category: 'PARCIAL 1 - Filtros', instruction: 'Visualizar las líneas del archivo "notas" cuyo cuarto carácter sea la letra "e".', hint: 'grep "^...e" ../notas', solutionHint: 'grep "^...e" ../notas', initialState: goDire, validationType: 'command', expectedCommandRegex: /grep.*\.\.\/notas/, commands: ['grep'], difficulty: 'medio' },

  { id: 'p1-22', category: 'PARCIAL 1 - FileSystem', instruction: 'Visualizar en formato extendido o detallado el contenido del directorio actual.', hint: 'ls -l', solutionHint: 'ls -l', initialState: goDire, validationType: 'command', expectedCommandRegex: /ls\s+-l/, commands: ['ls'], difficulty: 'fácil' },
  ...
  { id: 'p1-30', category: 'PARCIAL 1 - FileSystem', instruction: 'Trasladar al "directorio de login" el archivo "letras" con el mismo nombre.', hint: 'El archivo letras ya está en el home por defecto.', solutionHint: 'ok', initialState: goDire, validationType: 'text', expectedCommandRegex: /^(ok|okay|listo|hecho|si|.*ya.*est.*|\.)$/i, commands: [], difficulty: 'fácil' },

  { id: 'p1-31', category: 'PARCIAL 1 - FileSystem', instruction: 'Agregar al archivo "letras" el contenido unido de los archivos "nuevonum" y "num10".', hint: 'cat ../nuevonum ../num10 >> ../letras', solutionHint: 'cat ../nuevonum ../num10 >> ../letras', initialState: goDire, validationType: 'command', expectedCommandRegex: />>.*letras/, commands: ['cat'], difficulty: 'medio' },

  { id: 'p1-32', category: 'PARCIAL 1 - Filtros', instruction: 'Crear en el directorio actual el archivo "notaorder" inyectándole el contenido de "notas" ordenado por el primer campo en forma inversa.', hint: 'sort -k1r ../notas > notaorder', solutionHint: 'sort -k1r ../notas > notaorder', initialState: goDire, validationType: 'state', validateState: fileExists('notaorder'), commands: ['sort'], difficulty: 'medio' },

  { id: 'p1-33', category: 'PARCIAL 1 - FileSystem', instruction: 'Agregar a "notaorder" un listado con los nombres de los archivos del directorio actual. ¿Qué otro nombre tiene este directorio?', hint: 'ls >> notaorder. El directorio actual también se llama directorio de trabajo.', solutionHint: 'ls >> notaorder', initialState: goDire, validationType: 'both', expectedCommandRegex: />>\s*notaorder/, validateState: fileExists('notaorder'), commands: ['ls'], difficulty: 'medio' },

  { id: 'p1-34', category: 'PARCIAL 1 - Filtros', instruction: 'Visualizar el archivo "notas" ordenado numéricamente por la nota (segundo campo) en forma creciente.', hint: 'sort -k2n ../notas', solutionHint: 'sort -k2n ../notas', initialState: goDire, validationType: 'command', expectedCommandRegex: /sort.*-k2n/, commands: ['sort'], difficulty: 'medio' },

  { id: 'p1-35', category: 'PARCIAL 1 - Filtros', instruction: 'Visualizar el archivo "notas" ordenado numéricamente por la nota en forma decreciente.', hint: 'sort -k2nr ../notas', solutionHint: 'sort -k2nr ../notas', initialState: goDire, validationType: 'command', expectedCommandRegex: /sort.*-k2nr/, commands: ['sort'], difficulty: 'medio' },

  { id: 'p1-36', category: 'PARCIAL 1 - FileSystem', instruction: 'Agregar al archivo "enlanum" la fecha y hora del sistema actual.', hint: 'date >> ../enlanum', solutionHint: 'date >> ../enlanum', initialState: goDire, validationType: 'state', validateState: fileExists('../enlanum'), commands: ['date'], difficulty: 'medio' },

  { id: 'p1-37', category: 'PARCIAL 1 - Permisos', instruction: 'Contar mediante expresiones regulares los archivos en el "home directory" que tengan permiso de escritura activo para el dueño.', hint: 'ls -l .. | grep "^..w" | wc -l', solutionHint: 'ls -l .. | grep "^..w" | wc -l', initialState: goDire, validationType: 'command', expectedCommandRegex: /ls.*\|.*grep.*\|.*wc/, commands: ['ls', 'grep', 'wc'], difficulty: 'difícil' },

  { id: 'p1-38', category: 'PARCIAL 1 - Permisos', instruction: 'Visualizar los archivos ordinarios de "dire" que tengan permiso de lectura/ejecución para el grupo y lectura para otros.', hint: 'ls -l | grep "^-...r.xr"', solutionHint: 'ls -l | grep "^-...r.xr"', initialState: goDire, validationType: 'command', expectedCommandRegex: /ls.*\|.*grep/, commands: ['ls', 'grep'], difficulty: 'difícil' },

  { id: 'p1-39', category: 'PARCIAL 1 - FileSystem', instruction: 'Crear en "grupo" el archivo "archi" cuyo contenido sea el listado de todos los subdirectorios que hay en el "home directory".', hint: 'ls -l .. | grep "^d" > grupo/archi', solutionHint: 'ls -l .. | grep "^d" > grupo/archi', initialState: goDire, validationType: 'state', validateState: (s) => { const p = resolvePath(s.cwd, 'grupo/archi'); return s.getNode(p) ? null : 'No se encontró grupo/archi.'; }, commands: ['ls', 'grep'], difficulty: 'difícil' },

  // ============ BLOQUE 3: Comandos Básicos y Gestión Recursiva (40-47) ============

  { id: 'p1-40', category: 'PARCIAL 1 - Navegación', instruction: 'Visualizar el camino o trayectoria absoluta del directorio de trabajo actual.', hint: 'pwd', solutionHint: 'pwd', initialState: goHome, validationType: 'command', expectedCommandRegex: /^pwd$/, commands: ['pwd'], difficulty: 'fácil' },

  { id: 'p1-41', category: 'PARCIAL 1 - Navegación', instruction: 'Comandarse de forma directa al "home directory" sin usar rutas explícitas.', hint: 'cd', solutionHint: 'cd', initialState: (s) => { s.setCwd('/tmp'); }, validationType: 'state', validateState: cwdIs(HOME), commands: ['cd'], difficulty: 'fácil' },

  { id: 'p1-42', category: 'PARCIAL 1 - FileSystem', instruction: 'Crear una copia del archivo "letras" dentro de "dire/grupo" con el nuevo nombre "alfa".', hint: 'cp letras dire/grupo/alfa', solutionHint: 'cp letras dire/grupo/alfa', initialState: goHome, validationType: 'state', validateState: fileExists('dire/grupo/alfa'), commands: ['cp'], difficulty: 'fácil' },

  { id: 'p1-43', category: 'PARCIAL 1 - FileSystem', instruction: 'Agregar al archivo "alfa" un listado que contenga los nombres de todos los comandos disponibles en "/bin".', hint: 'ls /bin >> dire/grupo/alfa', solutionHint: 'ls /bin >> dire/grupo/alfa', initialState: goHome, validationType: 'state', validateState: fileExists('dire/grupo/alfa'), commands: ['ls'], difficulty: 'medio' },

  { id: 'p1-44', category: 'PARCIAL 1 - FileSystem', instruction: 'Borrar "nuevonum" de manera interactiva estándar de acuerdo a la protección de escritura.', hint: 'rm nuevonum', solutionHint: 'rm nuevonum', initialState: goHome, validationType: 'state', validateState: (s) => s.getNode(resolvePath(s.cwd, 'nuevonum')) ? 'El archivo nuevonum todavía existe.' : null, commands: ['rm'], difficulty: 'medio' },

  { id: 'p1-45', category: 'PARCIAL 1 - FileSystem', instruction: 'Crear en "dire" el archivo "palabras" conteniendo las 12 primeras letras del alfabeto (una por línea).', hint: 'cat > dire/palabras', solutionHint: 'cat > dire/palabras', initialState: goHome, validationType: 'state', validateState: fileExists('dire/palabras'), commands: ['cat'], difficulty: 'fácil' },

  { id: 'p1-46', category: 'PARCIAL 1 - FileSystem', instruction: 'Borrar de forma recursiva e integral el directorio "dire" junto con toda su estructura interna.', hint: 'rm -r dire', solutionHint: 'rm -r dire', initialState: goHome, validationType: 'state', validateState: (s) => s.getNode(resolvePath(s.cwd, 'dire')) ? 'El directorio dire todavía existe.' : null, commands: ['rm'], difficulty: 'medio' },

  { id: 'p1-47', category: 'PARCIAL 1 - Filtros', instruction: 'Agregar a "nuevonum" los 2 primeros comandos de "/bin" cuyos nombres comiencen con la letra "l".', hint: 'ls /bin | grep "^l" | head -2 >> nuevonum', solutionHint: 'ls /bin | grep "^l" | head -2 >> nuevonum', initialState: goHome, validationType: 'command', expectedCommandRegex: /ls.*\|.*grep.*\|.*head.*>>/, commands: ['ls', 'grep', 'head'], difficulty: 'difícil' },

  // ============ BLOQUE 4: Teoría del File System e i-nodos (48-53) ============

  { id: 'p1-48', category: 'PARCIAL 1 - Teoría', instruction: '¿El número de nodo-i contiene explícitamente los atributos de un archivo? Justifique (V/F).', hint: 'FALSO. El número de nodo-i es un índice hacia el nodo-i en disco.', solutionHint: 'FALSO', initialState: goHome, validationType: 'text', expectedCommandRegex: /^(falso|false|no|FALSO)/, commands: [], difficulty: 'fácil' },

  { id: 'p1-50', category: 'PARCIAL 1 - Teoría', instruction: '¿Los enlaces duros hacia un mismo archivo pueden tener idéntico nombre? (V/F).', hint: 'VERDADERO. Pueden tener el mismo nombre pero en diferentes directorios.', solutionHint: 'VERDADERO', initialState: goHome, validationType: 'text', expectedCommandRegex: /^(verdadero|true|si|sí|VERDADERO)/, commands: [], difficulty: 'fácil' },

  { id: 'p1-51', category: 'PARCIAL 1 - Teoría', instruction: 'Indicar qué datos NO están contenidos en un nodo-i: a) Modificación, b) Permisos, c) Nombre, d) Cantidad de enlaces, e) Contenido.', hint: 'El nombre está en el directorio, el contenido en los bloques de datos.', solutionHint: 'El NOMBRE del archivo y el CONTENIDO del archivo no están en el nodo-i.', initialState: goHome, validationType: 'text', expectedCommandRegex: /(nombre.*contenido|contenido.*nombre|c.*e)/i, commands: [], difficulty: 'medio' },

  { id: 'p1-52', category: 'PARCIAL 1 - Teoría', instruction: '¿Cuál es la diferencia operativa entre una trayectoria relativa y una trayectoria absoluta?', hint: 'Absoluta: desde la raíz (/). Relativa: desde el directorio actual.', solutionHint: 'Trayectoria absoluta: camino completo desde /. Relativa: camino parcial desde el directorio actual.', initialState: goHome, validationType: 'text', expectedCommandRegex: /(absoluta.*raíz|relativa.*actual|desde.*\/)/i, commands: [], difficulty: 'medio' },

  { id: 'p1-53', category: 'PARCIAL 1 - Teoría', instruction: 'Seleccione las características nativas de Linux: Multitarea, Multiusuario, Consolas virtuales, Exclusivo de celulares.', hint: 'Linux es multitarea, multiusuario y soporta consolas virtuales.', solutionHint: 'Multitarea, Multiusuario y Consolas virtuales.', initialState: goHome, validationType: 'text', expectedCommandRegex: /(multitarea.*multiusuario|multiusuario.*multitarea)/i, commands: [], difficulty: 'fácil' },

  // ============ BLOQUE 5: Identificación Mecánica de Comandos Básicos (54) ============

  { id: 'p1-54-A', category: 'PARCIAL 1 - Comandos', instruction: 'Comando para realizar el cierre seguro del sistema.', hint: 'shutdown', solutionHint: 'shutdown', initialState: goHome, validationType: 'command', expectedCommandRegex: /^shutdown$/, commands: ['shutdown'], difficulty: 'fácil' },

  { id: 'p1-54-B', category: 'PARCIAL 1 - Comandos', instruction: 'Comando que muestra el camino absoluto del directorio de trabajo actual (Print Working Directory).', hint: 'pwd', solutionHint: 'pwd', initialState: goHome, validationType: 'command', expectedCommandRegex: /^pwd$/, commands: ['pwd'], difficulty: 'fácil' },

  { id: 'p1-54-C', category: 'PARCIAL 1 - Comandos', instruction: 'Comando utilizado para limpiar visualmente toda la terminal.', hint: 'clear', solutionHint: 'clear', initialState: goHome, validationType: 'command', expectedCommandRegex: /^clear$/, commands: ['clear'], difficulty: 'fácil' },

  { id: 'p1-54-D', category: 'PARCIAL 1 - Comandos', instruction: 'Comando utilizado para visualizar la fecha y hora actual del sistema.', hint: 'date', solutionHint: 'date', initialState: goHome, validationType: 'command', expectedCommandRegex: /^date$/, commands: ['date'], difficulty: 'fácil' },

  { id: 'p1-54-E', category: 'PARCIAL 1 - Comandos', instruction: 'Comando para desplegar el calendario del mes corriente por pantalla.', hint: 'cal', solutionHint: 'cal', initialState: goHome, validationType: 'command', expectedCommandRegex: /^cal$/, commands: ['cal'], difficulty: 'fácil' },

  { id: 'p1-54-F', category: 'PARCIAL 1 - Comandos', instruction: 'Comando para cambiar el directorio de trabajo actual (Change Directory).', hint: 'cd', solutionHint: 'cd', initialState: goHome, validationType: 'command', expectedCommandRegex: /^cd$/, commands: ['cd'], difficulty: 'fácil' },

  { id: 'p1-54-G', category: 'PARCIAL 1 - Comandos', instruction: 'Comando para invocar las páginas del manual en línea del programador de Unix/Linux.', hint: 'man', solutionHint: 'man', initialState: goHome, validationType: 'command', expectedCommandRegex: /^man$/, commands: ['man'], difficulty: 'fácil' },

  { id: 'p1-54-H', category: 'PARCIAL 1 - Comandos', instruction: 'Comando para finalizar de forma ordenada la sesión de trabajo de la terminal actual.', hint: 'exit', solutionHint: 'exit', initialState: goHome, validationType: 'command', expectedCommandRegex: /^exit$/, commands: ['exit'], difficulty: 'fácil' },

  { id: 'p1-54-M', category: 'PARCIAL 1 - Teoría', instruction: "Descomponer los atributos de '-rwxr-xr-x 1 alumnox sop 5157 May 31 19:31 miarchivo'", hint: 'Tipo: regular (-). Permisos dueño rwx, grupo y otros r-x. 1 enlace. Dueño alumnox. Grupo sop. Tamaño 5157 bytes.', solutionHint: 'Es un archivo regular con permisos rwxr-xr-x, 1 enlace, dueño alumnox, grupo sop, 5157 bytes.', initialState: goHome, validationType: 'text', expectedCommandRegex: /(archivo.*regular|permisos.*rwx|dueño.*alumnox|grupo.*sop|5157)/i, commands: [], difficulty: 'medio' },

  // ============ BLOQUE 6: Administración Avanzada de Permisos (chmod/find) y Enlaces (55-62) ============

  { id: 'p1-55', category: 'PARCIAL 1 - Enlaces', instruction: '¿Un mismo archivo físico en disco puede responder a distintos nombres? Explique cómo se logra.', hint: 'Sí, mediante enlaces (físicos o simbólicos).', solutionHint: 'Sí, creando un enlace físico o simbólico. Esto crea una nueva entrada en el directorio apuntando al mismo archivo.', initialState: goHome, validationType: 'text', expectedCommandRegex: /(enlace|link|ln)/i, commands: [], difficulty: 'medio' },

  { id: 'p1-56', category: 'PARCIAL 1 - Permisos', instruction: 'Modificar en modo absoluto (simbólico con =) "archi100": dueño con rw-, grupo con r-x, otros con --x.', hint: 'chmod u=rw,g=rx,o=x archi100', solutionHint: 'chmod u=rw,g=rx,o=x archi100', initialState: goHome, validationType: 'state', validateState: fileMode('archi100', 'rw-r-x--x'), commands: ['chmod'], difficulty: 'medio' },

  { id: 'p1-57', category: 'PARCIAL 1 - Permisos', instruction: 'Modificar en modo relativo "texto20": sumar lectura/ejecución a dueño y grupo, y sumar lectura/escritura a otros, dejando los demás intactos.', hint: 'chmod ug+rx,o+rw texto20', solutionHint: 'chmod ug+rx,o+rw texto20', initialState: goHome, validationType: 'state', validateState: fileMode('texto20', 'rwxr-xrw-'), commands: ['chmod'], difficulty: 'medio' },

  { id: 'p1-58', category: 'PARCIAL 1 - Permisos', instruction: 'Modificar "texto" en modo numérico (octal): grupo con rw-, dueño con -wx, otros con -w-.', hint: 'chmod 362 texto', solutionHint: 'chmod 362 texto', initialState: goHome, validationType: 'state', validateState: fileMode('texto', '-wxrw--w-'), commands: ['chmod'], difficulty: 'medio' },

  { id: 'p1-59', category: 'PARCIAL 1 - Permisos', instruction: 'Quitar de forma masiva en un solo comando el permiso de ejecución a "otros" en todos los archivos ordinarios dentro de "lista".', hint: 'find lista -type f -exec chmod o-x {} \\;', solutionHint: 'find lista -type f -exec chmod o-x {} \\;', initialState: goHome, validationType: 'command', expectedCommandRegex: /find.*-exec.*chmod/, commands: ['find', 'chmod'], difficulty: 'difícil' },

  { id: 'p1-60', category: 'PARCIAL 1 - Permisos', instruction: 'Asignar a "archi10" de modo relativo: todos los permisos al dueño, sumar lectura al grupo y quitar ejecución a otros.', hint: 'chmod u+rwx,g+r,o-x archi10', solutionHint: 'chmod u+rwx,g+r,o-x archi10', initialState: goHome, validationType: 'state', validateState: fileMode('archi10', 'rwxr----x'), commands: ['chmod'], difficulty: 'medio' },

  { id: 'p1-61', category: 'PARCIAL 1 - Permisos', instruction: 'Asignar a "archi20" en modo absoluto simbólico: dueño con rwx, grupo con rw-, otros con r--. Denegar explícitamente los restantes.', hint: 'chmod u=rwx,g=rw,o=r archi20', solutionHint: 'chmod u=rwx,g=rw,o=r archi20', initialState: goHome, validationType: 'state', validateState: fileMode('archi20', 'rwxrw-r--'), commands: ['chmod'], difficulty: 'medio' },

  { id: 'p1-62', category: 'PARCIAL 1 - Permisos', instruction: 'Asignar a "archi30" mediante modo numérico (octal): dueño rwx, grupo rw-, otros r--.', hint: 'chmod 764 archi30', solutionHint: 'chmod 764 archi30', initialState: goHome, validationType: 'state', validateState: fileMode('archi30', 'rwxrw-r--'), commands: ['chmod'], difficulty: 'medio' },
