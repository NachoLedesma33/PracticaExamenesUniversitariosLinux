...
const BIN: VFSNode = d('bin', {
  ...
  'chmod': f('chmod', '[binario simulado]'),
  'chown': f('chown', '[binario simulado]'),
  'cp': f('cp', '[binario simulado]'),
  'dd': f('dd', '[binario simulado]'),
  'df': f('df', '[binario simulado]'),
  'echo': f('echo', '[binario simulado]'),
  'env': f('env', '[binario simulado]'),
  'false': f('false', '[binario simulado]'),
  'head': f('head', '[binario simulado]'),
  'hostname': f('hostname', '[binario simulado]'),
  'id': f('id', '[binario simulado]'),
  'kill': f('kill', '[binario simulado]'),
  'less': f('less', '[binario simulado]'),
  'login': f('login', '[binario simulado]'),
  'logout': f('logout', '[binario simulado]'),
  'lsblk': f('lsblk', '[binario simulado]'),
  'mail': f('mail', '[binario simulado]'),
  'mkdir': f('mkdir', '[binario simulado]'),
  'mount': f('mount', '[binario simulado]'),
  'mv': f('mv', '[binario simulado]'),
  'ps': f('ps', '[binario simulado]'),
  'pwd': f('pwd', '[binario simulado]'),
  'rm': f('rm', '[binario simulado]'),
  'rmdir': f('rmdir', '[binario simulado]'),
  'sed': f('sed', '[binario simulado]'),
  'sh': f('sh', '[binario simulado]'),
  'sort': f('sort', '[binario simulado]'),
  'tail': f('tail', '[binario simulado]'),
  'tar': f('tar', '[binario simulado]'),
  'touch': f('touch', '[binario simulado]'),
  'umount': f('umount', '[binario simulado]'),
  'uname': f('uname', '[binario simulado]'),
  'who': f('who', '[binario simulado]'),
  'whoami': f('whoami', '[binario simulado]'),
  'yes': f('yes', '[binario simulado]'),
}, true);
